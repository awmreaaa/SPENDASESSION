                ...
                <table class="table table-hover text-nowrap mb-3">
                  ...
                  @foreach ( $all_data as $student)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('edit-data-siswa',['id' => $student->id]) }}" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer justify-content-between">
                            <form action="{{ route('delete-data-siswa',['id' => $student->id]) }}" method="POST">
                              @csrf
                              @method('DELETE')
