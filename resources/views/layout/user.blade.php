...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#90B4EC; height:auto; ">
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand" style="display:flex; align-items:center; font-family:'Outfit', sans-serif; font-size:16px;" href="">SPENDASESSION/<br>user</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion" id="sidenavAccordion" style="background-color: #90B4EC; ">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="{{ route('user-kelas') }}">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-landmark"></i></div>
                                Kelas
                            </a>
                            <a class="nav-link collapsed" href="{{ route('user-all-studentdata') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Data Siswa
                            </a>
                            <a class="nav-link collapsed" href="{{ route('user-setting') }}">
