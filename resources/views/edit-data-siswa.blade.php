    ...
    <div class="container-fluid">
        ...
        <div class="row mb-6">
            ...
            <div class="col-mb-6 form-responsive">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('update-data-siswa',['id' => $data->id]) }}" method="POST" class="mt-3 mx-3">
                    @csrf
                    @method('PUT')
                    <div class="p-5 mb-3">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="nama" id="nama" class="form-control" value="{{ $data->nama }}" style="border-width: 1px; border-style: solid; border-color: black;">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="nis" class="col-sm-2 col-form-label">NIS</label>
                            <div class="col-sm-7">
                                <input type="text" id="nis" name="nis" value="{{ $data->nis }}" class="form-control" style="border-width: 1px; border-style: solid; border-color: black;">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="nisn" class="col-sm-2 col-form-label">NISN</label>
                            <div class="col-sm-7">
                                <input type="text" id="nisn" name="nisn" value="{{ $data->nisn }}" class="form-control" style="border-width: 1px; border-style: solid; border-color: black;">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <select id="kelas" name="class_id" class="form-select" style="border-width: 1px; border-style: solid; border-color: black;">
                                    ...
                                    @foreach($class as $kelas)
                                        <option value="{{ $kelas->id }}" {{ $data->class_id == $kelas->id ? 'selected' : '' }}>{{ $kelas->class_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
