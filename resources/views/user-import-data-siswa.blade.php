            ...
            <div class="col-mb-6 form-responsive">
                ...
                <div class="card-header">
                    <h5 class="mt-5 btn-link text-black font">
                        <a href="{{ route('user-data') }}" class="mt-5 btn-link text-black fw-bold">
                ...
                <form action="{{ route('user-import-data-siswa') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card p-5" style="background-color:#9ABCEE">
                    <div class="form-group">
                        <label for="file">Pilih file untuk diimpor:</label>
                        <select name="file_type" class="form-select form-select-lg mb-2" aria-label="Large select example">
